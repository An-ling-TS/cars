 ...
 * @version: 
 * @Author: Liang Anqing
 * @Date: 2020-06-30 11:19:10
 * @LastEditors: Liang Anqing
 * @LastEditTime: 2020-06-30 11:51:59
 */ 
...
!function(a,b){
    b.shinejs=a,Function.prototype.bind||(
        Function.prototype.bind=function(a){
            ...
            var e=function(){
                return c.apply(
                this instanceof d&&a?this:a,b.concat(Array.prototype.slice.call(arguments)))
            };
            ...
            try{
                ...
                c.Config=function(a){
                    ...
                    this.blur=40,
                    this.blurPow=1,
                    this.shadowRGB=new c.Color(0,0,0),this.applyValues(a)
                },
                ...
                c.Light=function(a){
                    this.position=a||new c.Point(0,0),
                    this.intensity=1
                },
                ...
                ,c.Shadow=function(a){
                    ...
                    c.Shadow.prototype.destroy=function(){
                        ...
                        this.domElement=null,this.position=null
                    },
                    c.Shadow.prototype.draw=function(a,b){
                        ...
                        for(var e=[],f=0;f<b.numSteps;f++){
                            ...
                            l=-b.offset*c.x*i,
                            m=-b.offset*c.y*i,n=d*b.blur*j/512,
                            o=this.getShadow(b.shadowRGB,k,l,m,n);
                            e.push(o)}this.drawShadows(e)
                        }
                        ...
                        c.Shadow.prototype.enableAutoUpdates=function(){
                            ...
                            c.Shadow.prototype.disableAutoUpdates=function(){
                                ...
                                a&&(this.fnHandleViewportUpdate=null,
                            ...
                            c.Shadow.prototype.handleViewportUpdate=function(){
                                ...
                                this.position.x=a.left+.5*a.width,
                                this.position.y=a.top+.5*a.height
                            },
                            ...
                            c.Splitter=function(a,b){
                                ...
                                this.wordElements=[],
                                this.elements=[],
                                this.text=""},c.Splitter.prototype.split=function(a,b){
                                ...
                                c.Splitter.prototype.splitChildren=function(a,b,c,d){
                                    ...
                                    c.Splitter.prototype.splitText=function(a,b,c,d){
                                        for(var e=a.textContent,f=e.length,g=null,h=0;f>h;h++){
                                            var i=e.charAt(h);
                                            if(g||(g=document.createElement("span"),
                                                g.className=d+"word",
                                                c.appendChild(g),
                                                ...
                                                k.innerHTML=i,k.className=d+"letter",
                                    ...
                                    c.StyleInjector.getInstance=function(){
                                        return c.StyleInjector.instance_||(
                                    ...
                                    c.StyleInjector.prototype.inject=function(a,b){
                                        if(b=b||window.document,this.injections[a]!==b){
                                            ...
                                            return b.getElementsByTagName("head")[0].insertBefore(c,d),
                                                this.injections[a]=b,c
                                        }
                                    },
                                    c.Timing=function(){},
                                    c.Timing.debounce=function(a,b,c){
                                        var d=0/0;return function(){
                                            b=b||0,c=c||this;
                                            var e=arguments;
                                    ...
                                    c.Shine=function(a,b,d,e){
                                        ...
                                        this.shadowProperty=e||(
                                            this.elememtHasTextOnly(a)?"textShadow":"boxShadow"
                                        ),
                                        this.shadows=[],
                                    ...
                                    c.Shine.prototype.destroy=function(){
                                        ...
                                        for(var a=this.shadows.length-1;a>=0;a--)
                                            ...
                                            this.light=null,this.shadows=null,
                                            this.splitter=null,
                                            this.fnDrawHandler=null
                                    },
                                    ...
                                    c.Shine.prototype.updateContent=function(a){
                                        ...
                                        this.splitter.split(
                                            a,
                                            !a&&!this.elememtHasTextOnly(this.domElement)
                                        );
                                    ...
                                    c.Shine.prototype.enableAutoUpdates=function(){
                                        ...
                                        for(var b=this.shadows.length-1;b>=0;b--){
                                            var c=this.shadows[b];c.enableAutoUpdates()
                                        }
                                    },
                                    ...
                                    c.Shine.prototype.getPrefixed=function(a){
                                        for(var b=this.domElement||document.createElement("div"),
                                            c=b.style,d=["webkit","ms","Moz","Webkit","O"],
                                            e=a.charAt(0).toUpperCase()+a.substring(1),
                                            f=0;f<d.length;f++){
                                            var g=d[f]+e;if(g in c)return g
                                        }
                                        return a
                                    },
                                    c.Shine.prototype.isCSSPropertySupported=function(a,b){
                                        var c=document.createElement("div"),
                                        d=c.style,e=["-webkit-","-ms-","-moz-"];
                                        return d.cssText=e.join(a+":"+b+";"),
                                        !!d.length&&(void 0===document.documentMode||document.documentMode>9)
                                    },
